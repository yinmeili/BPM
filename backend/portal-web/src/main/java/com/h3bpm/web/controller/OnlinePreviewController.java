...
public class OnlinePreviewController extends ControllerBase {
    ...
    @RequestMapping(value = "/previewMyFile", method = RequestMethod.GET, produces = "application/json;charset=utf8")
    @ResponseBody
    public void previewMyFile(@RequestParam(required = false, name = "fileId") String fileId) throws IOException {
