    ...
    angular.module("ion-datetime-picker", ["ionic"]).directive("ionDatetimePicker", function () {
        return {
            ...
            controller: ["$scope", "$ionicPopup", "$ionicPickerI18n", "$timeout", function (e, t, n, i) {
                function o(e, t) {
                    t = t || 0,
                        ...
                        d.day = e.getDate(),
                        d.hour = e.getHours(),
                        d.minute = e.getMinutes(),
                        d.second = e.getSeconds(),
                        d.date = e
                }
                function a() {
                    var t = new Date(e.year, e.month, e.day, e.hour, e.minute, e.second);
                    e.isEnabled(t.getDate(), !0) ? o(t) : (e.year = d.year,
                        e.month = d.month,
                        e.day = d.day,
                        e.hour = d.hour,
                        e.minute = d.minute,
                ...
                function l(e) {
                    var t = new Date(e)
                        , n = isNaN(t.getTime());
                    return n && (t = new Date),
                        t.setHours(0, 0, 0, 0, 0),
                        t
                }
                e.i18n = n,
                    e.bind = {},
                    e.rows = [0, 1, 2, 3, 4, 5],
                    e.cols = [1, 2, 3, 4, 5, 6, 7],
                    e.weekdays = [0, 1, 2, 3, 4, 5, 6];
                var d = {
                    year: e.year,
                    month: e.month,
                    day: e.day,
                ...
                e.showPopup = function () {
                    ...
                    e.processModel = function () {
                        ...
                        e.year = e.dateEnabled ? t.getFullYear() : 0,
                            e.month = e.dateEnabled ? t.getMonth() : 0,
                            e.day = e.dateEnabled ? t.getDate() : 0,
                            e.hour = e.timeEnabled ? t.getHours() : 0,
                            e.minute = e.timeEnabled ? t.getMinutes() : 0,
                            e.second = e.secondsEnabled ? t.getSeconds() : 0,
                            c()
                    }
                    ;
                var c = function () {
                    a();
                    var t = new Date(e.year, e.month, e.day, e.hour, e.minute, e.second);
                    e.dateEnabled && (e.year = t.getFullYear(),
                        e.month = t.getMonth(),
                        e.day = t.getDate(),
                        e.bind.year = e.year,
                        e.bind.month = e.month,
                        e.firstDay = new Date(e.year, e.month, 1).getDay(),
                        e.mondayFirst && (e.firstDay = (e.firstDay || 7) - 1),
                        e.daysInMonth = s(e.year, e.month)),
                        e.timeEnabled && (e.hour = t.getHours(),
                            e.minute = t.getMinutes(),
                            e.second = t.getSeconds(),
                            e.meridiem = e.hour < 12 ? "AM" : "PM",
                            e.bind.hour = e.meridiemEnabled ? (e.hour % 12 || 12).toString() : e.hour.toString(),
                            e.bind.minute = (e.minute < 10 ? "0" : "") + e.minute.toString(),
                            e.bind.second = (e.second < 10 ? "0" : "") + e.second.toString(),
                            e.bind.meridiem = e.meridiem)
                }
                    , s = function (e, t) {
                ...
                e.changeBy = function (t, n) {
                    if (+t) {
                        ...
                        e[n] += +t,
                            "month" !== n && "year" !== n || (e.day = Math.min(e.day, s(e.year, e.month))),
                            c()
                    }
                }
                    ,
                    e.change = function (t) {
                        var n = e.bind[t];
                        n && "meridiem" === t ? (n = n.toUpperCase(),
                            "AM" === n && "PM" === e.meridiem ? e.hour -= 12 : "PM" === n && "AM" === e.meridiem && (e.hour += 12),
                            c()) : (+n || 0 === +n) && (e[t] = +n,
                                "month" !== t && "year" !== t || (e.day = Math.min(e.day, s(e.year, e.month))),
                                c())
                    }
                    ,
            ...
            link: function (e, t, n, i) {
                e.dateEnabled = "date" in n && "false" !== n.date,
                    e.timeEnabled = "time" in n && "false" !== n.time,
                    e.dateEnabled === !1 && e.timeEnabled === !1 && (e.dateEnabled = e.timeEnabled = !0),
                    e.mondayFirst = "mondayFirst" in n && "false" !== n.mondayFirst,
                    e.secondsEnabled = e.timeEnabled && "seconds" in n && "false" !== n.seconds,
                    e.meridiemEnabled = e.timeEnabled && "amPm" in n && "false" !== n.amPm,
                    e.monthStep = +e.monthStep || 1,
                    e.hourStep = +e.hourStep || 1,
                    e.minuteStep = +e.minuteStep || 1,
                    e.secondStep = +e.secondStep || 1,
                    e.prepare(),
                    i.$render = function () {
                        e.modelDate = i.$viewValue,
                            e.processModel()
                    }
                    ,
                    e.commit = function () {
                        e.modelDate = new Date(e.year, e.month, e.day, e.hour, e.minute, e.second),
                            i.$setViewValue(e.modelDate)
                    }
                    ,
