            ...
            $scope.getColumns = function () {
                ...
                columns.push({
                    ...
                    "mRender": function (data, type, full) {
                        ...
                        return "<a title=\""+data+"\" target='_blank' href='WorkItemSheets.html?WorkItemID=" + full.ObjectID + "'>" + data + "</a>";
                    }
                });
                columns.push({
                    "mData": "tagName",
                ...
                columns.push({
                    "mRender": function (data, type, full) {
                        ...
                        return `
                                <button class='btn btn-sm btn-default' ng-click='toUpdateFlow(${full})' title='收藏到我的知识'>
            ...
            $scope.dtOptions_tabfinishWorkitem = {
                ...
                "fnServerParams": function (aoData) {
                    ...
                    aoData.push(//name的值是传输数据的key，value的值是传输数据的value
                        {"name": "startTimeStart", "value": $filter("date")($scope.StartTimeStart, "yyyy-MM-dd")},
                        {"name": "startTimeEnd", "value": $filter("date")($scope.StartTimeEnd, "yyyy-MM-dd")},
                        {"name": "flowCodes", "value": $scope.WorkflowCodes},
                        {"name": "name", "value": $scope.name },
                        {"name": "tagName", "value": $scope.tagName },
                        {"name": "endTimeStart", "value": $filter("date")($scope.EndTimeStart, "yyyy-MM-dd")},
                        {"name": "endTimeEnd", "value": $filter("date")($scope.EndTimeEnd, "yyyy-MM-dd")},
                    );
                },
