(function ($) {
    ...
    $.Controls.FormButton.Inherit($.Controls.BaseControl, {
        ...
        //渲染html内容
        HtmlRender: function () {
            this.$Input = $("<button class='btn btn-default btn-block' name='" + this.DataField + "' class='form-control'>" + this.DisplayName + "</button>");//.attr("name", this.DataField).addClass("form-control").text(this.DisplayName);
