...
function PickerDialogShowWait(ctx)
{
	...
	if (resultControl !=null)
	{
		...
		if(nav4)
			...
			parent=resultControl.parentElement;
		var L_GearToolTip_TEXT="查询正在进行，请稍候...";
		var L_PleaseWait_TEXT="正在处理查询，请稍候。";
...
function MSOWebPartPage_GetLocalizedStrings()
{
	...
	var L_ResetPartPersonalizationDialog_TXT="重置此 Web 部件将丢失您所做的任何更改。是否确实要进行此操作? 若要重置此 Web 部件，请单击“确定”。若要保留更改，请单击“取消”。";
	var L_RemoveConnection_TXT="是否确实要删除 %0 Web 部件和 %1 Web 部件之间的连接? 若要删除该连接，请单击“确定”。若要保留该连接，请单击“取消”。";
	var L_ExportPersonalization_TXT="此 Web 部件页已经过个性化设置。因此，一个或多个 Web 部件属性可能包含机密信息。请确保属性包含的信息都是他人可阅读的安全信息。导出此 Web 部件之后，可以使用文本编辑器(如 Microsoft 记事本)查看 Web 部件说明文件(.webpart 或 .dwp)中的属性。";
	var L_GetPropertiesFailure_ERR="现在无法检索属性。";
	var L_SaveDirtyParts_TXT="此网页上的一个或多个 Web 部件的内容已被更改。若要保存更改，请按“确定”。若要放弃更改，请按“取消”。";
	var L_ToolPaneWidenToolTip_TXT="加宽";
	var L_ToolPaneShrinkToolTip_TXT="收缩";
	var L_ToolPartExpandToolTip_TXT="展开工具部件: %0";
	var L_ToolPartCollapseToolTip_TXT="折叠工具部件: %0";
	var L_WebPartBackgroundColor_TXT="Web 部件背景色";
	var L_TransparentTooltip_TXT="透明 Web 部件背景色";
	var L_InvalidURLPath_ERR="该 URL 对 %0 属性无效。请检查 URL 拼写和路径并重试。";
	var L_InvalidFolderPath_ERR="该文件夹路径对 %0 属性无效。请检查路径名并重试。";
	var L_InvalidFilePath_ERR="该文件或文件夹的路径无效。请检查路径并重试。";
	var L_FileOrFolderUnsupported_ERR="当前浏览器不支持指向文件或文件夹的链接。若要指定指向文件或文件夹的链接，必须使用 Microsoft Internet Explorer 5.0 或更高版本";
	var L_Link_TXT="链接";
	var L_TransparentLiteral_TXT="透明";
	var L_ContentEditorSaveFailed_ERR="无法保存您的更改。";
	var L_AccessDenied_ERR="保存 Web 部件属性时访问被拒绝: 可能是由于 Web 部件直接嵌入到该网页中，或者是您没有足够的权限保存属性。";
	var L_NoInitArgs_ERR="不能创建或修改连接。一个 Web 部件没有任何数据字段。";
	var s=new Object();
...
var L_NewFormLibTb4_Text="选择要合并的文档，然后单击工具栏上的“合并选择的文档”。";
...
var L_NewFormLibTb6_Text="一次只能重新链接 500 个文档，请修改选择范围并重试。";
...
var L_RestoreVersion_Text="还原";
var L_DeleteVersion_Text="删除";
var L_DenyVersion_Text="拒绝此版本";
var L_UnPublishVersion_Text="取消发布此版本";
...
var L_Version_NoRestore_Current_ERR="无法还原当前版本。";
...
var L_Version_unpublish_Confirm_Text="是否确实要取消发布此版本的文档?";
var L_Version_deny_Confirm_Text="是否确实要拒绝此版本的文档?";
...
var L_Version_Delete_Confirm_Text="是否确实要删除此版本?";
var L_Version_Recycle_Confirm_Text="是否确实要将此版本发送到网站回收站?";
var L_Version_NoDelete_Current_ERR="无法删除当前签入版本、主要版本或已批准版本。";
...
var L_Version_RecycleAll_Confirm_Text="是否确实要将与此文件关联的所有以前版本发送到网站回收站?";
var L_Version_DeleteAllMinor_Confirm_Text="是否确实要删除此文件所有以前的草稿版本?";
var L_Version_RecycleAllMinor_Confirm_Text="是否确实要将此文件所有以前的草稿版本发送到网站回收站?";
