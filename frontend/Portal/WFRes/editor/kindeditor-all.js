    ...
    _extend(KUploadButton, {
        init: function (options) {
            ...
            var html = [
                ...
                hiddenElements.join(''),
                '<input type="hidden" name="BizObjectID" value="' + K.BizObjectID + '" />',
                '<input type="hidden" name="SchemaCode" value="' + K.SchemaCode + '" />',
...
KindEditor.plugin('flash', function (K) {
    var self = this, name = 'flash', lang = self.lang(name + '.'),
		allowFlashUpload = false,// K.undef(self.allowFlashUpload, true),
...
KindEditor.plugin('insertfile', function (K) {
    var self = this, name = 'insertfile',
		allowFileUpload = false,// K.undef(self.allowFileUpload, true),
		allowFileManager = false,// K.undef(self.allowFileManager, false),
		formatUploadUrl = K.undef(self.formatUploadUrl, true),
		uploadJson = K.undef(self.uploadJson, self.basePath + 'php/upload_json.php'),
		extraParams = K.undef(self.extraFileUploadParams, {}),
